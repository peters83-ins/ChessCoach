...
class CourseLibraryDialog(QDialog):
    ...
    def __init__(
        ...
        self.search.setAccessibleName("Course search label")
        filters.addWidget(self.search)
        from PySide6.QtWidgets import QLineEdit

        self.query = QLineEdit()
        self.query.setAccessibleName("Search courses")
        self.query.setPlaceholderText("Opening, theme, or course title")
        filters.addWidget(self.query, 1)
        self.side = QComboBox()
        self.side.setAccessibleName("Filter courses by side")
        self.side.addItems(["All sides", "White", "Black", "Both"])
        filters.addWidget(self.side)
        self.level = QSpinBox()
        self.level.setAccessibleName("Filter courses by rating")
        ...
        self.filter_summary.setAccessibleName("Course filter results")
        ...
        self.empty.setAccessibleName("Course empty state")
        self.empty.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.addWidget(self.empty)
        self.start = QPushButton("Start / Continue")
        self.start.setAccessibleName("Start or continue selected course")
...
class CourseDetailDialog(QDialog):
    def __init__(
        ...
        self.modules.setAccessibleName("Course modules")
...
class CoursePlayerDialog(QDialog):
    def __init__(
        ...
        *,
        ...
        self.concept.setAccessibleName("Course concept and instructions")
        layout.addWidget(self.concept)
        self.board = ChessBoard(self._game_for_current())
        self.board.setAccessibleName("Course exercise chess board")
        ...
        self.next_button.setAccessibleName("Continue to next course exercise")
